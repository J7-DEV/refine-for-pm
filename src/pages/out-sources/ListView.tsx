    ...
    <List createButtonProps={{ type: "primary" }}>
      <Table {...tableProps} rowKey="id">
        ...
        <Table.Column
          ...
          sorter={(a: IOutSource, b: IOutSource) => a.rate - b.rate}
        ...
        <Table.Column
          ...
          onFilter={(value, record: IOutSource) => record.type.indexOf(value as string) === 0}
        />
        <Table.Column
          width={120}
          dataIndex='id'
